...
export const PRODUCTS = [
  ...
  {
    id: 'p2', name: 'Package B', category: 'Package', price: 1500,
    inclusion: 'Themed Cake (7x5)\nw/ Printed Toppers\nw/ 12pcs Cupcakes',
    image: packageBImg,
    dailyLimit: 5, stock: 10, active: true, dateExceptions: [],
  },
  {
    id: 'p3', name: 'Package C', category: 'Package', price: 2000,
    inclusion: 'Themed Cake (7x5)\nw/ Printed Toppers\nw/ 12pcs Cupcakes\nw/ Balloons',
    image: packageCImg,
    dailyLimit: 5, stock: 10, active: true, dateExceptions: [],
  },
  {
    id: 'p4', name: 'Package D', category: 'Package', price: 3000,
    inclusion: 'Themed Cake (7x5)\nw/ Printed Toppers\nw/ Balloons\nw/ Tarpaulin 7x5',
    image: packageDImg,
    dailyLimit: 5, stock: 10, active: true, dateExceptions: [],
  },
  {
    id: 'p5', name: 'Package E', category: 'Package', price: 1000,
    inclusion: 'Themed Cake (9x7)\nw/ Printed Toppers',
    image: cake,
    dailyLimit: 5, stock: 10, active: true, dateExceptions: [],
  },
  {
    id: 'p6', name: 'Package AB', category: 'Package', price: 1400,
